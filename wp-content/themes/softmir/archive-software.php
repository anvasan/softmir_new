...
<div class="container">
    <div style="background: #fff; padding: 1.5rem 2rem; border-radius: var(--radius); box-shadow: var(--shadow); margin-bottom: 1.5rem;">
        ...
        <p class="section-subtitle" style="margin-bottom: 0;">Найдите оптимальное решение для вашего бизнеса среди проверенных продуктов</p>
    </div>
        ...
        <aside class="catalog-sidebar">
            <div class="filter-box">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                    ...
                    <a href="<?php echo get_post_type_archive_link('software'); ?>" style="font-size: 0.8rem;">Сбросить</a>
                </div>
...
?>
                    ...
                    <button type="submit" class="btn btn-primary" style="width: 100%; margin-top: 0.5rem;">Применить</button>
                </form>
            </div>
        </aside>
...
?>
            ...
            <?php
                ...
                <div style="text-align: center; padding: 3rem; background: #fff; border-radius: var(--radius); box-shadow: var(--shadow);">
                    ...
                    <p style="font-size: 0.875rem; color: var(--gray-400); margin-top: 0.5rem;">Попробуйте изменить параметры фильтрации</p>
                </div>
            <?php
endif;
wp_reset_postdata(); ?>
